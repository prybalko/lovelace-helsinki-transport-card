...
class HelsinkiTransportCard extends HTMLElement {
    constructor() {
        super();
        this.attachShadow({
            mode: 'open'
        ...
        for (const entityId of entityIds) {
            ...
            const timetable = entity.attributes.departures.slice(0, maxEntries).map((departure) => {
                ...
                return departure.cancelled && !showCancelled ? `` :
                    ...
                    <div class="time">
                        <span class="live" style="color: ${departure.is_live ? 'green' : 'gray'}">●</span>
...
customElements.define('helsinki-transport-card', HelsinkiTransportCard);
